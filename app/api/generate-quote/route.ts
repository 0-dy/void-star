...
const QUOTE_DATABASE: Record<string, Quote[]> = {
    ...
    "사이버펑크": [
        { text: `"이 세계가 가짜라면, 내 기억 속 당신의 체온도 가짜일까?"`, source: "- 아가씨 (2016) (분위기 차용)", keywords: ["혼란", "의심", "진실", "기억", "사랑", "가짜"] },
        { text: `"기억은 데이터일 뿐이야. 중요한 건 지금 네가 느끼는 감정이지."`, source: "- 사이보그지만 괜찮아 (2006)", keywords: ["위로", "감정", "현재", "존재", "마음", "기억"] },
        { text: `"시스템 밖으로 나가는 것만이 유일한 생존 방법이다."`, source: "- 늑대사냥 (2022)", keywords: ["반항", "탈출", "자유", "위험", "결단", "시스템"] },
        { text: `"모든 게 연결되어 있다는 건, 모든 걸 잃을 준비가 되어 있다는 뜻이기도 하지."`, source: "- 브로커 (2022)", keywords: ["위험", "연결", "상실", "두려움", "철학", "잃음"] },
        { text: `"가상 현실에서 피 흘리면, 현실에서도 죽어. 조심해."`, source: "- 콘크리트 유토피아 (2023) (아포칼립스)", keywords: ["경고", "공포", "위기", "현실", "생존", "죽음"] },
        { text: `"눈을 감으면 보이는 세상이 더 진짜 같을 때가 있어."`, source: "- 루시드 드림 (2017)", keywords: ["도피", "환상", "몽환", "슬픔", "위로", "꿈"] },
        { text: `"인간을 인간답게 만드는 건 완벽함이 아니라 결함이야."`, source: "- 인랑 (2018)", keywords: ["위로", "인간애", "철학", "불완전", "긍정", "인간"] },
        { text: `"우린 모두 시스템의 부품일 뿐이야, 고장 나면 교체되는."`, source: "- 반도 (2020)", keywords: ["허무", "우울", "분노", "디스토피아", "절망", "시스템"] },
        { text: `"우주의 끝에서, 나는 나 자신과 마주했다."`, source: "- 더 문 (2023)", keywords: ["자아", "고독", "성찰", "우주", "초월", "끝"] }
    ],
    "철학적": [
